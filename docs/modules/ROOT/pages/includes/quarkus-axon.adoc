...
a|icon:lock[title=Fixed at build time] [[quarkus-axon_quarkus-axon-discovery-aggregates-enabled]] [.property-path]##link:#quarkus-axon_quarkus-axon-discovery-aggregates-enabled[`quarkus.axon.discovery.aggregates.enabled`]##
...
a|icon:lock[title=Fixed at build time] [[quarkus-axon_quarkus-axon-discovery-aggregates-included-packages]] [.property-path]##link:#quarkus-axon_quarkus-axon-discovery-aggregates-included-packages[`quarkus.axon.discovery.aggregates.included-packages`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.axon.discovery.aggregates.included-packages+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_AXON_DISCOVERY_AGGREGATES_INCLUDED_PACKAGES+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_AXON_DISCOVERY_AGGREGATES_INCLUDED_PACKAGES+++`
endif::add-copy-button-to-env-var[]
--
|list of string
|
