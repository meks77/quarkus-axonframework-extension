...
a| [[quarkus-axonframework-extension_quarkus-axon-server-hostname]] [.property-path]##`quarkus.axon.server.hostname`##
...
a| [[quarkus-axonframework-extension_quarkus-axon-server-grpc-port]] [.property-path]##`quarkus.axon.server.grpc-port`##
...
a| [[quarkus-axonframework-extension_quarkus-axon-server-context]] [.property-path]##`quarkus.axon.server.context`##
