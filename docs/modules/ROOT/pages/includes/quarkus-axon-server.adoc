...
a|icon:lock[title=Fixed at build time] [[quarkus-axon-server_quarkus-axon-server-dev-services-use-dcb]] [.property-path]##link:#quarkus-axon-server_quarkus-axon-server-dev-services-use-dcb[`+++quarkus.axon.server.dev-services.use-dcb+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.axon.server.dev-services.use-dcb+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_AXON_SERVER_DEV_SERVICES_USE_DCB+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_AXON_SERVER_DEV_SERVICES_USE_DCB+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++false+++`
...
[.description]
--
the number of threads used as commands threads. If not set, the default of the axon framework is used. The value is set to `io.axoniq.framework.axonserver.connector.api.AxonServerConfiguration++#++setCommandThreads(int)`
...
a| [[quarkus-axon-server_quarkus-axon-server-storage-engine]] [.property-path]##link:#quarkus-axon-server_quarkus-axon-server-storage-engine[`+++quarkus.axon.server.storage-engine+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.axon.server.storage-engine+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_AXON_SERVER_STORAGE_ENGINE+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_AXON_SERVER_STORAGE_ENGINE+++`
endif::add-copy-button-to-env-var[]
--
a|`aggregate-based`, `dcb`
