...
link:05-08-EventUpcasting.adoc[← Previous: Event Upcasting]

link:05-10-ExceptionHandling.adoc[Next: Exception Handling →]
...
----
<1> Necessary annotation, that this Saga is registered with field for serialization, if the serializer cannot access fields(see link:05-20-Serialization.adoc[Serialization])
...
NOTE: The dependency quarkus-axon-transaction for transaction management is automatically added. For detailed information see link:05-15-Transaction.adoc[Transaction].
