...
By default the configured TokenStore is used(see link:05-06-TokenStores.adoc[Token Stores]). You have the possibility to override the default and use the In-Memory-Token-Store.
