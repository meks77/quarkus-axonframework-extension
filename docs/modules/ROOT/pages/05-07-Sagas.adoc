...
----
<1> Necessary annotation, that this Saga is registered with field for serialization, if the serializer cannot access fields(see link:05-16-Serialization.adoc[Serialization])
...
NOTE: The dependency quarkus-axon-transaction for transaction management is automatically added. For detailed information see link:05-12-Transaction.adoc[Transaction].
