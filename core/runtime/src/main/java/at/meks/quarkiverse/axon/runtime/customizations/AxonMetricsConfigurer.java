...
public interface AxonMetricsConfigurer {
    ...
    /**
     * Configures the given {@link AxonFrameworkConfigurer} instance to enable or customize metric tracking.
     *
     * @param configurer the Axon {@link AxonFrameworkConfigurer} instance to be customized
     */
