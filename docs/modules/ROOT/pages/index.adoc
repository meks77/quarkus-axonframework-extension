...
[source,java]
----
include::includes/main/java/at/meks/quarkiverse/axonframework/example/model/Api.java[leveloffset=+1,opts=optional]
----
...
[source,java]
----
include::{examples-java-source}/model/Giftcard.java[leveloffset=+1,opts=optional]
----
...
[source,java]
----
include::{examples-java-source}/model/DomainServiceExample.java[leveloffset=+1,opts=optional]
----
...
[source,java]
----
include::{examples-java-source}/projection/GiftcardProjection.java[leveloffset=+1,opts=optional]
----
...
[source,java]
----
include::{examples-java-source}/interfaces/rest/GiftcardResource.java[leveloffset=+1,opts=optional]
----
...
[source,java]
----
include::{examples-java-test-source}/ApplicationTest.java[leveloffset=+1,opts=optional]
----
