...
[.description]
--
TODO: not present in axon framework 5? Sets the explicitFlush field specifying whether to explicitly call EntityManager. flush() after inserting the Events published in this Unit of Work.
