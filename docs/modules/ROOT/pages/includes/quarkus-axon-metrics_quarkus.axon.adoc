...
a| [[quarkus-axon-metrics_quarkus-axon-metrics-use-dimensions]] [.property-path]##link:#quarkus-axon-metrics_quarkus-axon-metrics-use-dimensions[`+++quarkus.axon.metrics.use-dimensions+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.axon.metrics.use-dimensions+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_AXON_METRICS_USE_DIMENSIONS+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_AXON_METRICS_USE_DIMENSIONS+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++true+++`
