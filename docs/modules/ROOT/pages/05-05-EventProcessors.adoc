...
The set values are also used as default for the other defined tracking processors.
...
Therefor the default `Persistent Stream Configuration` is only used to define default value for named configurations, what works equally to Tracking and Pooled Streaming Processor configuration.
