...
import at.meks.quarkiverse.axonframework.extension.test.model.Api;
import at.meks.quarkiverse.axonframework.extension.test.model.DomainServiceExample;
import at.meks.quarkiverse.axonframework.extension.test.model.Giftcard;
import at.meks.quarkiverse.axonframework.extension.test.projection.GiftcardInMemoryHistory;
import at.meks.quarkiverse.axonframework.extension.test.projection.GiftcardQueryHandler;
import at.meks.quarkiverse.axonframework.extension.test.projection.GiftcardView;
...
public abstract class AbstractConfigurationTest {
    ...
    void frameworkConfigurationWorks() {
        ...
        Optional<EventProcessor> eventProcessorOptional = configuration.eventProcessingConfiguration().eventProcessor(
                "at.meks.quarkiverse.axonframework.extension.test.projection");
